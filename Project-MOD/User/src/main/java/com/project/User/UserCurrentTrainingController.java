...
@RefreshScope
@RestController
public class UserCurrentTrainingController {
	...
	public String createProducts(@RequestBody CurrentTraining currentTraining) {
		...
		return restTemplate.exchange("http://localhost:8084/completedTraining", HttpMethod.POST, entity, String.class)
				.getBody();
	}
	...
	public String updateProduct(@RequestBody CurrentTraining currentTrainings) {
		...
		return restTemplate
				.exchange("http://localhost:8084/updateCurrentTraining", HttpMethod.PUT, entity, String.class)
				.getBody();
	}
	...
	public String deleteProduct(@PathVariable("id") String id) {
		...
		return restTemplate.exchange("http://localhost:8084/deleteCurrentTraining/{id}" + id, HttpMethod.DELETE, entity,

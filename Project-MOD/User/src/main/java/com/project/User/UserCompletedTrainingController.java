...
@RefreshScope
@RestController
public class UserCompletedTrainingController {
	...
	public String updateProduct(@RequestBody CompletedTraining completedTrainings) {
		...
		return restTemplate
				.exchange("http://localhost:8084/updateCompletedTraining", HttpMethod.PUT, entity, String.class)
				.getBody();
	}
	...
	public String deleteProduct(@PathVariable("id") String id) {
		...
		return restTemplate.exchange("http://localhost:8084/deleteCompletedTraining/{id}" + id, HttpMethod.DELETE,
